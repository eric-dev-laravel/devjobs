...
@section('styles')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.11.2/css/lightbox.min.css" integrity="sha512-ZKX+BvQihRJPA8CROKBhDNvoc2aDMOdAlcm7TUQY+35XYtrd3yh95QOOhsPDQY9QnKE0Wqag9y38OIgEvb88cA==" crossorigin="anonymous" />
@endsection
...
@section('content')
    ...
    <div class="mt-10 mb-20 md:flex items-start">
        <div class="md:w-3/5">
            ...
            <p class="block text-gray-700 font-bold my-2">
                Caregoria: <span class="font-normal"> {{ $vacante->categoria->nombre}}</span>
            </p>
            <p class="block text-gray-700 font-bold my-2">
            ...
            <h2 class="text-2xl text-center mt-10 mb-5">Conocimientos y Tecnologías</h2>
            @php
            ...
            <a href="/storage/vacantes/{{ $vacante->imagen }}" data-lightbox="imagen" data-title="Vacante {{ $vacante->titulo }}">
                <img src="/storage/vacantes/{{ $vacante->imagen }}" class="w-40 mt-10" alt="img-vacante">
            </a>
